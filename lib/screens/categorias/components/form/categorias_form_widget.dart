  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: AlertDialog(
        ...
        content:
            ScopedBuilder<CategoriasFormStore, Exception, Map<String, dynamic>>(
                  ...
                  return Form(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                onPressed: () async {
                                  if (categoriasFormController
                                    ...
                                    Map<String, Object> categoria = {
                                      ...
                                      'descricao': categoriasFormController
                                          .descricao.text,
                                      'data': Timestamp.now(),
                                      'bloqueado': false,
                                      'valorTotal': 0,
                        ...
                        if (categoriaId != null &&
                            !categoriasFormController.bloqueado)
                          Padding(
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return DeleteBoxWidget(
                                      funcaoExclusao:
                                          categoriasFormStore.deleteCategoria,
                                      entity: categoria,
                                      path: '/categorias/',
                                      entityName: entityName,
                                    );
